...
const steps = [
  ...
  },
  {
    ...
    desc: "Place your order today — your first delivery arrives within 7 days. After that, deliveries flow continuously on your chosen schedule. These eggs haven't sat in a cold room for a month. They're the real thing.",
    accent: "First delivery within 7 days. Then weekly.",
  },
];
    ...
    <div className="w-full bg-[#EDE8DC] min-h-screen">
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-24">
        ...
        >
          ...
          <div>
            <p className="font-serif text-xl font-bold text-[#1B3A2D] mb-1">Order today. Receive in 7 days.</p>
            <p className="text-[#0F1F18]/60 text-base leading-relaxed">
              Your first batch arrives within 7 days of confirming your reservation. After that, eggs flow continuously — no single bulk delivery day. Every customer is on their own rolling weekly cycle so freshness is never compromised.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-[#FAF7F0]/60 text-base md:text-lg max-w-3xl mx-auto leading-relaxed mb-3">
            ...
            one open, it had already spent weeks in a cold room you have never seen, handled by people you will never know.
          </p>
          <p className="text-[#FAF7F0]/60 text-base md:text-lg max-w-3xl mx-auto leading-relaxed mb-8">
            Every NatiNest carton shows you the batch number and the collection date.
            That is not marketing. That is just honesty.
          </p>
          <div className="flex flex-wrap justify-center gap-6 md:gap-10">
            {[
              { val: "7 days",  label: "First delivery after order" },
